                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg w-64 focus:ring-2 focus:ring-blue-500 text-gray-600 bg-white focus:border-blue-500 transition-all"
                                />
                            </div>
